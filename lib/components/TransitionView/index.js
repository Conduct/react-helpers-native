...
var TransitionViewWithoutMemo = function (_a) {
    ...
    return (React.createElement(AnimatedView, __assign({ style: [
            {
        ...
        return (React.createElement(AnimatedView, { style: [
            ...
            React.createElement(View, { style: childWrapperStyle, onLayout: function (_a) {
                    var nativeEvent = _a.nativeEvent;
                    var height = nativeEvent.layout.height;
                    if (measuredChildHeightsByKey[id] === height) {
                        return;
                    }
                    setMeasuredChildHeightsByKey(function (state) {
                        var _a;
                        return (__assign(__assign({}, state), (_a = {}, _a[id] = nativeEvent.layout.height, _a)));
                    });
                } }, childElement)));
    })));
};
